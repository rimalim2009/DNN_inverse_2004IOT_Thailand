...
Ds = np.array([[515 * 10**-6], [420 * 10**-6], [350 * 10**-6],
               [298 * 10**-6],
               [250 * 10**-6]])  # representative diameters of grain-size classes
...
read_setfile("config_g5_300grid_thai.ini")
(x, C, spoints, deposit) = forward([4000, 2.5, 2.5, 0.01, 0.01, 0.01, 0.01,0.01])
#ipdb.set_trace()
...
if __name__ == "__main__":
    ...
    np.savetxt("start_param_random_5000_thai_g5.csv", a, delimiter=",")
    params=np.loadtxt('start_param_random_5000_thai_g5.csv', delimiter=',')
    ...
    np.savetxt('eta_5000_g6_300grid_thai_g5.csv', eta, delimiter=',')
...
import numpy as np
icond = np.loadtxt('start_param_random_5000_thai_g5.csv', delimiter=',')
#icond_new=icond[:,1:]
...
print(icond.shape)
eta = np.loadtxt('eta_5000_g6_300grid_thai_g5.csv', delimiter=',')
